...
import { FaSass, FaHtml5, FaReact, FaAngular, FaFigma } from "react-icons/fa";
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="skills flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 justify-between gap-14 md:gap-20">
        ...
        <div className="skill flex items-center gap-5">
          ...
          <h2 className="font-semibold text-4xl">Tailwind</h2>
        </div>
        <div className="skill flex items-center gap-5">
          <FaReact className="text-5xl md:text-7xl"></FaReact>
          <h2 className="font-semibold text-4xl">React</h2>
        </div>
        <div className="skill flex items-center gap-5">
          <FaAngular className="text-5xl md:text-7xl"></FaAngular>
          <h2 className="font-semibold text-4xl">Angular</h2>
        </div>
        <div className="skill flex items-center gap-5">
